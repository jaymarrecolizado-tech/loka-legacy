...
$columns = ['ID', 'Date/Time', 'Destination', 'Purpose', 'Requester', 'Dept', 'Driver', 'Status', 'Duration', 'Km', 'Dispatch', 'Arrival'];
$colWidths = [10, 26, 34, 28, 22, 20, 20, 16, 15, 14, 20, 20];
...
foreach ($trips as $trip) {
    ...
    $rowData = [
        ...
        strlen($trip->department_name ?: '-') > 14 ? substr($trip->department_name ?: '-', 0, 14) . '..' : ($trip->department_name ?: '-'),
        strlen($trip->driver_name ?: '-') > 14 ? substr($trip->driver_name ?: '-', 0, 14) . '..' : ($trip->driver_name ?: '-'),
